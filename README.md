<h2>
  Hello Everyone 👋, I'm Mustafa Gamal
  <img src="https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExdjhjcm9qeXFtOHFiMThhamNmOTBnNTdndW5jNnZpNmgyc2FyZWt1ZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/QXwtfadqo7wbfmT46H/giphy.gif" width="40">
</h2>

<p>Mobile App Developer Specializing In Flutter, Android Development, And .NET Backend Development.</p>
...
const mustafaGamal = {
    ...
    technologies: {
        ...
        tools: {
            ...
            CI_CD: ["GitHub Actions", "Codemagic", "Azure DevOps Pipelines", "Fastlane"]
        },
        deployment: {
